            ...
            <div className="w-full lg:w-[40%] flex flex-col gap-8">
               ...
               <div className="bg-warm-ivory p-10 border border-muted-gold shadow-md rounded-sm">
                  ...
                  <div className="flex justify-center gap-4">
                     ...
                     {/* X (Twitter) */}
                     <a href="#" className="w-10 h-10 rounded-full flex items-center justify-center text-white bg-black hover:scale-110 transition-transform duration-200">
                        <svg viewBox="0 0 24 24" fill="currentColor" stroke="none" className="w-[16px] h-[16px]"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                     </a>
                     {/* TripAdvisor */}
