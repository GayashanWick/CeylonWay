...
const FloatingWhatsApp = () => {
  return (
    ...
    >
      ...
      {/* Tooltip */}
      <span className="absolute right-full mr-4 bg-white text-forest-green px-4 py-2 rounded-sm font-sans text-sm font-semibold whitespace-nowrap shadow-md opacity-0 pointer-events-none transition-opacity duration-300 group-hover:opacity-100 hidden md:block border border-gray-100">
        Message Us
      </span>
    </motion.a>
  );
