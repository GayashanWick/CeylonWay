...
const Footer = () => {
  return (
    <footer className="bg-charcoal text-warm-ivory pt-20 pb-10 px-6 md:px-12 border-t border-forest-green">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">

        {/* Brand */}
        <div className="md:col-span-1">
          <a href="#" className="font-serif text-3xl font-bold tracking-tight text-warm-ivory block mb-4">
            Ceylon Way
          </a>
        ...
        <div>
          ...
          <ul className="space-y-4">
            <li><a href="#" className="font-sans text-sm text-warm-ivory/70 hover:text-warm-ivory transition-colors">Off-Grid Tours</a></li>
            <li><a href="#" className="font-sans text-sm text-warm-ivory/70 hover:text-warm-ivory transition-colors">Wellness Retreats</a></li>
            <li><a href="#" className="font-sans text-sm text-warm-ivory/70 hover:text-warm-ivory transition-colors">Cultural Trails</a></li>
            <li><a href="#" className="font-sans text-sm text-warm-ivory/70 hover:text-warm-ivory transition-colors">Camping Gear</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4">
            <li><a href="#" className="font-sans text-sm text-warm-ivory/70 hover:text-warm-ivory transition-colors">Our Story</a></li>
            <li><a href="#" className="font-sans text-sm text-warm-ivory/70 hover:text-warm-ivory transition-colors">Sustainability</a></li>
            <li><a href="#" className="font-sans text-sm text-warm-ivory/70 hover:text-warm-ivory transition-colors">Travel Blog</a></li>
            <li><a href="#" className="font-sans text-sm text-warm-ivory/70 hover:text-warm-ivory transition-colors">Contact Us</a></li>
          </ul>
        </div>
      ...
      <div className="max-w-7xl mx-auto pt-8 border-t border-warm-ivory/10 flex flex-col md:flex-row justify-between items-center text-warm-ivory/50 font-sans text-xs">
        <p>© 2026 Ceylon Way</p>
